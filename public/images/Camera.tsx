...
const Camera = ({className, ...props}: IconProps) => {
  return (
    <div className={'bg-[#3a5bbf] rounded-full p-[15px]'}>
      <svg className={className} {...props} fill='#fff' version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg'
        xmlnsXlink='http://www.w3.org/1999/xlink'
        viewBox='0 0 198.931 198.931' xmlSpace='preserve'>
        <g>
          <g>
            <g>
