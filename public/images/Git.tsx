...
const Git = ({className, ...props}: IconProps) => {
  return (
    <svg className={className} {...props} width='20px' height='20px' viewBox='0 0 256 256'
      xmlns='http://www.w3.org/2000/svg'
      preserveAspectRatio='xMinYMin meet' fill='#ffffff'>
